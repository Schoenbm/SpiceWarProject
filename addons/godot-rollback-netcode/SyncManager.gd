...
func _call_get_local_input() -> Dictionary:
	...
	#print(str(input) + ":" + str(multiplayer.multiplayer_peer.get_unique_id()))
	return input
...
func _physics_process(_delta: float) -> void:
	...
	if not _mechanized:
		...
		if _spectating:
			...
			if(local_input != {}):
				print("input is :" +str(local_input))
...
func _calculate_data_hash(input: Dictionary) -> int:
	...
	#print(str(serialized_hash) + " : " + str(multiplayer.multiplayer_peer.get_unique_id()))
